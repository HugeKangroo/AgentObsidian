---
id: source-x-2049534755729707205
title: 'Source: 如果你读过我之前关于 ChatGPT、Claude 以及 Clawdbot 记忆系统的文章，你就'
type: source
...
raw_captures:
- vault/raw/x-bookmarks/x-2049534755729707205/manifest.json
source_score:
  relevance: 1.0
  novelty: 0.85
...
> [!info] Raw Evidence
> Raw capture manifest: `vault/raw/x-bookmarks/x-2049534755729707205/manifest.json`

## Why This Was Saved

This source is connected to [[Hermes Agent Memory System]] and should be integrated before any bookmark cleanup decision.

## Original

- URI: https://x.com/dotey/status/2049534755729707205
- Author: @dotey
- Processor: `tool_card_extractor`
- Priority: `high`
...
Reasons: priority:high, domain_present, typed_or_tagged, no_duplicate_seen, uri_present, raw_text_substantial, author_present, source_type_present, linked_evidence_pending, processor:tool_card_extractor, routing_metadata_present, value_type_present, next_action_visible
...
- https://pbs.twimg.com/media/HHFnyLpaEAArswH.jpg
